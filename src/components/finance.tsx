...
const aiSystems = data.ais.lowDensity;
...
export default function Finance({ userId, disclosure }: FinanceProps) {
  ...
  const handleDisclosureClick = (disclosureType: Disclosure) => {
    ...
    updateDisclosure.mutate({ userId, disclosure: disclosureType });
  };
