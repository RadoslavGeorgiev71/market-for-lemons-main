        ...
        <div>
            ...
            {page === 1 && (
                <div className="center items-center p-10 bg-gray-50 rounded-md space-y-5 flex flex-col">
                    ...
                    <div className="flex flex-col items-center space-y-5 shadow p-6 bg-white rounded w-full">
                        <p>Do you have any experience with deception detection of hotel reviews? </p>
                        <div className="flex flex-row justify-center space-x-5">
                            {Array.from({ length: 5 }, (_, i) => i).map((n) => (
                            <label key={n}>
                    ...
                    <div className="flex flex-col items-center space-y-5 shadow p-6 bg-white rounded w-full">
                        <p>Do you have any experience with skin cancer detection?  </p>
                        <div className="flex flex-row justify-center space-x-5">
                            {Array.from({ length: 5 }, (_, i) => i).map((n) => (
                            <label key={n}>
                    ...
                    <div className="flex flex-col items-center space-y-5 shadow p-6 bg-white rounded w-full">
                        ...
                        <p className="mt-[-10]">Please answer on the following scale from 1 to 10 where 1 means "not at all willing to take risks" and 10 means "very willing to take risks</p>
                        <div className="flex flex-row justify-center space-x-5">
                    ...
                    <Button onClick={() => setPage(2)} disabled={loanApproval === null || deceptionDetection === null || skinCancerDetection === null || risk === null}>
                        Next
                    </Button>
                </div>
            )}
            {page === 2 && (
                <div className="center items-center p-10 bg-gray-50 rounded-md space-y-5 flex flex-col">
                    ...
                    <div className="flex flex-col items-center space-y-5 shadow p-6 bg-white rounded w-full">            
                        <p>I like testing the functions of new technical systems. </p>
                        <div className="flex flex-row justify-center space-x-5">
                            {Array.from({ length: 6 }, (_, i) => i).map((n) => (
                            <label key={n}>
                    ...
                    <div className="flex flex-col items-center space-y-5 shadow p-6 bg-white rounded w-full">
                        <p>For this question please select option "Largely disagree". </p>
                        <div className="flex flex-row justify-center space-x-5">
                            {Array.from({ length: 6 }, (_, i) => i).map((n) => (
                            <label key={n}>
                    ...
                    <Button onClick={() => setPage(3)} disabled={technology1 === null || technology2 === null || technology3 === null || attention1 === null || technology4 === null}>
                        Next
                    </Button>
                </div>
            )}
            {page === 3 && (
                <div className="center items-center p-10 bg-gray-50 rounded-md space-y-5 flex flex-col">
                    ...
                    <div className="flex flex-col items-center space-y-5 shadow p-6 bg-white rounded w-full">
                        <p>For this question please answer "Strongly agree".</p>
                        <div className="flex flex-row justify-center space-x-5">
                            {Array.from({ length: 5 }, (_, i) => i).map((n) => (
                            <label key={n}>
                    ...
                    <div className="flex flex-col items-center space-y-5 shadow p-6 bg-white rounded w-full">
                        <p>My current employment includes working with artificial intelligence. </p>
                        <div className="flex flex-row justify-center space-x-5">
                            {Array.from({ length: 5 }, (_, i) => i).map((n) => (
                            <label key={n}>
                    ...
                    <div className="flex flex-col items-center space-y-5 shadow p-6 bg-white rounded w-full">
                        <p>I am confident interacting with artificial intelligence. </p>
                        <div className="flex flex-row justify-center space-x-5">
                            {Array.from({ length: 5 }, (_, i) => i).map((n) => (
                            <label key={n}>
                    ...
                    <div className="flex flex-col items-center space-y-5 shadow p-6 bg-white rounded w-full">
                        <p>I understand what the term artificial intelligence means. </p>
                        <div className="flex flex-row justify-center space-x-5">
                            {Array.from({ length: 5 }, (_, i) => i).map((n) => (
                            <label key={n}>
                    ...
                    <Button onClick={() => onSubmit()} disabled={aiLiteracy1 === null || attention2 === null || aiLiteracy2 === null || aiLiteracy3 === null || aiLiteracy4 === null}>
                        Start first task
                    </Button>
                </div>
            )}
