export default function Page3() {
  return (
    <div className="p-4 border rounded-lg space-y-4">
        ...
        <p>Low-quality AI systems are AIs that do not exhibit high prediction accuracy in test data, <strong>or</strong> AI systems that do not have high quality training data, <strong>or</strong> both. Therefore, they make a correct prediction with a probability of <strong>15%</strong>.</p>
